# Baby Name Generator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:babynamegenerator-api:1.1.12'
}
```
...
```java
import com.apiverve.babynamegenerator.BabyNameGeneratorAPIClient;
import com.apiverve.babynamegenerator.APIResponse;
import com.apiverve.babynamegenerator.APIException;

// Initialize the client
BabyNameGeneratorAPIClient client = new BabyNameGeneratorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/babynamegenerator](https://docs.apiverve.com/ref/babynamegenerator)
...
- **Documentation:** [https://docs.apiverve.com/ref/babynamegenerator](https://docs.apiverve.com/ref/babynamegenerator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/babynamegenerator-api/issues)
