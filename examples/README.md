# Baby Name Generator API - Examples

This folder contains example code for using the Baby Name Generator API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/babynamegenerator',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/babynamegenerator");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/babynamegenerator](https://docs.apiverve.com/ref/babynamegenerator)
